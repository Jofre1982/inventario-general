            ...
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <div class="card-description">
                        {{ __('40 años, 3 hijas, Divorciado, Ingeniero en software. Actualmente se desempeña como auxiliar administratvo en la entidad de la Registraduria Especial de Inirida') }}
                    </div>
                </div>
                <div class="card-footer">
