...
<div class="content px-3">
    ...
    <div class="card">
        <div class="card-body p-0">
            ...
            <table class="table table-striped table-bordered dataTable no-footer" id="dataTableBuilder" width="100%" role="grid" aria-describedby="dataTableBuilder_info" style="width: 100%;">
                <thead>
                    <tr role="row">
                        ...
                        <th title="Cantidad" class="sorting" tabindex="0" aria-controls="dataTableBuilder" rowspan="1" colspan="1" aria-label="Cantidad: activate to sort column ascending" style="width: 83px;">Cantidad</th>
                ...
                <tbody>
                    <tr role="row" class="odd">
                        <td class="sorting_1">JABON LIQUIDO</td>
                        <td>0</td>
                        <td>
                            <form method="POST" action="http://127.0.0.6/products/6" accept-charset="UTF-8"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="6UEAT4b1cI8ijKV3xRoTG6yScozcxqQmsipZ3WT8">
                                <div class="btn-group">
                    ...
                    <tr role="row" class="even">
                        <td class="sorting_1">JABON EN POLVO</td>
                        <td>90</td>
                        <td>
                            <form method="POST" action="http://127.0.0.6/products/4" accept-charset="UTF-8"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="6UEAT4b1cI8ijKV3xRoTG6yScozcxqQmsipZ3WT8">
                                <div class="btn-group">
                    ...
                    <tr role="row" class="odd">
                        <td class="sorting_1">ESCOBA</td>
                        <td>40</td>
                        <td>
                            <form method="POST" action="http://127.0.0.6/products/5" accept-charset="UTF-8"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="6UEAT4b1cI8ijKV3xRoTG6yScozcxqQmsipZ3WT8">
                                <div class="btn-group">
                    ...
                    <tr role="row" class="even">
                        <td class="sorting_1">Aerosol Matavoladores Rai Frasco *285cc</td>
                        <td>99</td>
                        <td>
                            <form method="POST" action="http://127.0.0.6/products/1" accept-charset="UTF-8"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="6UEAT4b1cI8ijKV3xRoTG6yScozcxqQmsipZ3WT8">
                                <div class="btn-group">
            ...
            <div class="dataTables_info" id="dataTableBuilder_info" role="status" aria-live="polite">Showing 1 to 4 of 4 entries</div>
